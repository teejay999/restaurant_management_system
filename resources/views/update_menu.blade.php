    ...
    <div>
        <div class="row">
            ...
            <div class="container justify-content-center mx-auto">
                <form class="needs-validation" method="post" action="{{ route('admin.update_menu',$menu->id) }}" novalidate enctype="multipart/form-data">
                    @csrf
                    <div class="mt-5 w-25">
                        <label for="validationCustom01">Name</label>
                        <input type="text" class="form-control" name="name" id="validationCustom01" placeholder=" Enter Menu Name" value="{{ isset($menu->name) ? $menu->name : '' }}" required>
                    ...
                    <div class="mt-4 w-50">
                        <button class="btn btn-success" type="submit">Update Menu Detail</button>
                    </div>
                </form>														
            </div>
        </div>
