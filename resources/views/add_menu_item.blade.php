    ...
    <div>
        <div class="row">
            ...
            <div class="container justify-content-center mx-auto">
                <form class="needs-validation" method="post" action="{{ route('admin.add_menu_item') }}" novalidate enctype="multipart/form-data">
                 @csrf
                 <div class="mt-5 w-25">
                     <label for="validationCustom01">Name</label>
                     <input type="text" class="form-control" name="name" id="validationCustom01" placeholder=" Enter Menu Item Name" value="{{ isset($name) ? $name : '' }}" required>
                 ...
                 <div class="mt-3 w-25">
                    ...
                    <input type="text" class="form-control" name="price" id="validationCustom02" placeholder=" Enter Price" value="{{ isset($price) ? $price : '' }}" required>
                    <div class="invalid-feedback">
                ...
                <div class="mt-5 w-25">
                    ...
                    <textarea name="description" id="validationCustom03" class="form-control" cols="30" rows="10"></textarea>
                    <div class="invalid-feedback">
                 ...
                 <div class="mt-4 w-50">
                     <button class="btn btn-success" type="submit">Add Menu Item Detail</button>
                 </div>
                </form>									
            </div>
        </div>
