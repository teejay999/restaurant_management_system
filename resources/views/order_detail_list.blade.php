...
<body id="page-top">
    <div>
        <div class="row">
            <div id="wrapper" class="col-2" style="height:100%;">
                        ...
                        <div style="position:relative; top: 50px; right:20px;">
                            <table class="text-center table table-striped">
                                ...
                                <tbody>
                                    ...
                                    @endforeach
                                    <tr style="background-color: #928282;" class="text-light">
