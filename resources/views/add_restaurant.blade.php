    ...
    <div>
        <div class="row">
            ...
            <div class="container justify-content-center mx-auto">
                <form class="needs-validation" method="post" action="{{ route('admin.add_restaurant') }}" novalidate enctype="multipart/form-data">
                 @csrf
                 <div class="mt-5 w-25">
                 ...
                 <div class="mt-3 w-50">
                     ...
                     <input type="text" class="form-control" name="address" id="validationCustom02" placeholder=" Enter Address" value="{{ isset($address) ? $address : '' }}" required>
                     <div class="invalid-feedback">
                 ...
                 <div class="mt-3 w-25">
                     ...
                     <select name="restaurant_owner" class="form-select" id="validationCustom04" required>
                        <option selected disabled value="">Select Restaurant Owner</option>
                         ...
                         <option name="{{ $restaurant_owner->name }}"  value="{{ $restaurant_owner->id }}">{{$restaurant_owner->name}}</option>
                         @endforeach
                       </select>
                       <div class="invalid-feedback">
                 ...
                 <div class="mt-3 w-25">
                     ...
                     <input type="tel" class="form-control" name="contact_number" id="validationCustom03" placeholder=" Enter Phone" value="{{ isset($address) ? $address : '' }}" required>
                     <div class="invalid-feedback">
                         Please Provide Restaurant's Name. 
                     </div>
                 </div>
                 <div class="mt-3 w-25">
                     <label for="validationImage">Logo</label>
                     <input type="file" class="form-control" name="logo" id="validationImage" placeholder="Select Logo" accept="image/png, image/gif, image/jpeg" required>
                     <div class="invalid-feedback">
                         Please provide an image file. 
                     </div>
                 </div>
                 <div class="mt-4 w-50">
                     <button class="btn btn-success" type="submit">Add Restaurant Detail</button>
                 </div>
             </form>									
            </div>
        </div>
